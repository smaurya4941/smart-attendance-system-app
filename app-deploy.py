...
try:
    ...
    st.warning("Face recognition not available. Only QR code attendance will work.")
...
# Sidebar menu
menu_options = ["Home", "Register Student", "View Students", "QR Attendance", "View Attendance"]
if FACE_RECOGNITION_AVAILABLE:
    menu_options.insert(-1, "Face Attendance")
...
if menu == "Home":
    ...
    if not FACE_RECOGNITION_AVAILABLE:
        st.warning("⚠️ Face recognition is not available. Only QR code attendance is enabled.")
...
# ---------------- Face Attendance ----------------
elif menu == "Face Attendance" and FACE_RECOGNITION_AVAILABLE:
