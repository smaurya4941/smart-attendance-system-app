...
def add_student(name, roll, class_name, img_file):
    ...
    try:
        ...
        # Face Encoding (only if face recognition is available)
        if img_file and FACE_RECOGNITION_AVAILABLE:
        ...
        elif img_file and not FACE_RECOGNITION_AVAILABLE:
            st.info("Face recognition not available. Only QR code will be generated.")
